...
function prochainTrain() {
    ...
    monitoredStopVisits.forEach((stopVisit, index) => {
            ...
            if (operatorRef.startsWith("SNCF_ACCES_CLOUD")) {
                ...
                if (destinationDisplay.startsWith("la") || destinationDisplay === "la Verrière") {
                    destName = "La Verrière"
                }
                ...
                if (lineref === "STIF:Line::C01741:" && operatorRef.startsWith("SNCF_ACCES_CLOUD") && destName !== station) {
